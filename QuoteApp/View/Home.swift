...
struct Home: View {
    ...
    var sortedArrayOfNumbers: [Int] {
        return [arrayOfNumbers.nextElementAfter(currentIndex) ?? 323123,
                arrayOfNumbers.nextElementAfter(currentIndex + 1) ?? 0,
                arrayOfNumbers[currentIndex],
                arrayOfNumbers.elementBefore(currentIndex) ?? 312321
        ]
    }
