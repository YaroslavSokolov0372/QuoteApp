...
struct CollectionViewSketch: View {
                ...
                ForEach(collectionVM.quotes.indices.reversed(), id: \.self) { index in
                    if collectionVM.settingsMode {
                        ...
                        TextField("Quote", text: $collectionVM.quote, axis: .vertical)
                            ...
                            .offset(y: -320)
                            .offset(y: CGFloat(collectionVM.currentIndex) * 310)
                        ...
                        Text(collectionVM.quotes[index].quote)
                            ...
                            .animation(.default.speed(0.5), value: collectionVM.currentIndex)
                            .offset(y: -320)
                            .offset(y: CGFloat(collectionVM.currentIndex) * 310)
                            .frame(width: 300, height: 280, alignment: .leading)
                    }
...
struct CollectionViewSketch_Previews: PreviewProvider {
    static var previews: some View {
        CollectionViewSketch()
    }
}
